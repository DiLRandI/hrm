...
export default function Payroll() {
  ...
  }, [selectedPeriodId, isHR, activeSection]);
        ...
        <Route
          ...
          element={
            <div className="card-grid">
              <div className="card">
                <h3>Schedules</h3>
                <p className="metric">{schedules.length}</p>
                <p className="inline-note">Active payroll schedules</p>
              </div>
              <div className="card">
                <h3>Open periods</h3>
                <p className="metric">{periods.filter((period) => period.status !== PAYROLL_PERIOD_FINALIZED).length}</p>
                <p className="inline-note">Draft or reviewed</p>
              </div>
              <div className="card">
                <h3>Payslips</h3>
                <p className="metric">{payslips.length}</p>
                <p className="inline-note">Available to download</p>
              </div>
              <div className="card">
                <h3>Quick actions</h3>
                <div className="row-actions">
                  {isHR && <NavLink className="ghost-link" to="/payroll/run">Create period</NavLink>}
                  {isHR && <NavLink className="ghost-link" to="/payroll/setup">Manage setup</NavLink>}
                  <NavLink className="ghost-link" to="/payroll/payslips">View payslips</NavLink>
                </div>
              </div>
            </div>
          }
